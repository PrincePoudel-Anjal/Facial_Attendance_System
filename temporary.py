...
def login():
    ...
    if face_name in known_names and flag_continue:
        best_distance = 999
        ...
        if label_image.faceimage is None:
            ...
            label_image.image_ = IMage  # store reference to avoid garbage collection
            label_image.configure(image=label_image.image_)
            forget_login()
            button_back.grid_forget()
